        ...
        <div class="col-md-7">
            @forelse ($posts as $post)
                <div class="card mb-4">
                    ...
                    @if ($post->thumbnail)
                    <a href="{{ route('post.show', $post->slug) }}"></a>
                        <img class="card-img-top" src="{{ asset($post->takeImage()) }}" alt="thumbnail" style="height: 350px; object-fit: cover; object-position: center">
                    @endif
            ...
            @empty
                <div class="alert alert-info text-center col-md-12 d-flex justify-content-center pb-0">
